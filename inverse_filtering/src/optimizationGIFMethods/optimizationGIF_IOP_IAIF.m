function error = optimizationGIF_IOP_IAIF(VTorder, GSorder, LipRad, HPflag, speechData, timeMarks, C)
%error = optimizationGIF_IOP_IAIF(VTorder, GSorder, LipRad, HPflag)
%
...
%   - HPflag: High-Pass filter flag (e.g. 0 or 1)
    ...
    %% Inverse Filtering
    [invFilterResults.glotFlow, invFilterResults.glotFlowD] = iop_iaif_olaf(speechData.speech,...
                                                                       speechData.fs,...
                                                                       VTorder,...
                                                                       GSorder,...
                                                                       LipRad,...
