...
%   [G,Gd,a,ag] = iaif_olaf(s,fs,p_vt,p_gl,d,tmarks,hpfilt)
%
% Description
...
function [G,Gd,a,ag,hpfilter_out] = iaif_olaf(s,fs,p_vt,p_gl,d,hpfilt,tmarks,hpfilter_in)
    ...
    for n = 1:nf
        ...
        Hg1 = lpc(x.*win,1);
        [y,Z_Hg1] = filter(Hg1,1,signal,Z_Hg1);
        y = y(idx);
